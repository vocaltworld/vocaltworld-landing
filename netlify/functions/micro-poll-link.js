...
exports.handler = async (event) => {
  ...
  try {
    ...
    // URL completo che userai come pagina di voto
    ...
    // Se invece vuoi il JSON (debug / fetch), usa ?format=json oppure POST.
    ...
    return json(200, { ok: true, token, url, exp }, headers);
  } catch (err) {
    return json(
      500,
